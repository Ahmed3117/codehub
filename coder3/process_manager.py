...
from coder3.utils.constants import VSCODE_COMMAND, EDITORS
...
class ProcessManager:
    ...
    def launch_editor(self, session_id: str, project_path: str,
        ...
        try:
            env = os.environ.copy()
            env["CODER3_SESSION_ID"] = session_id
            env["GDK_BACKEND"] = "x11"
    ...
    def check_dead_sessions(self) -> list[str]:
        ...
        """
        dead = []
        for session_id in list(self._xids.keys()):
